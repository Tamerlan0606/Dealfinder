...
REGION_MARKERS={
    "Ростовская область":("ростовская область","ростов-на-дону","ростове-на-дону","ростов на дону","ростове на дону"),
    "Ставропольский край":("ставропольский край","ставрополь","пятигорск","ессентуки"),
